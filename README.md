...
| [`@axisj/beautiful-grid-mui`](./packages/mui) | Material UI editor integrations for BeautifulGrid |
| [`@axisj/beautiful-grid-mantine`](./packages/mantine) | Mantine editor integrations for BeautifulGrid |
